            ...
            return a = e, o = [{
                ...
                value: function() {
                    ...
                    jQuery(".js-sparkline:not(.js-sparkline-enabled)").each(function(a, t) {
                        ...
                        s[l] ? (s[l](), "line" === l && ((o.data("chart-range-min") >= 0 || o.data("chart-range-min")) && (n.chartRangeMin = o.data("chart-range-min")), (o.data("chart-range-max") >= 0 || o.data("chart-range-max")) && (n.chartRangeMax = o.data("chart-range-max"))), n.width = o.data("width") || "120px", n.height = o.data("height") || "80px", n.tooltipPrefix = o.data("tooltip-prefix") ? o.data("tooltip-prefix") + " " : "", n.tooltipSuffix = o.data("tooltip-suffix") ? " " + o.data("tooltip-suffix") : "", "100%" === n.width ? i || (i = !0, jQuery(window).on("resize.pixelcave.helpers.sparkline", function(a) {
    ...
    var i = function() {
        ...
        return a = e, (t = [{
            ...
            value: function() {
				...
				this._windowW = o.default.getWidth(), 
            ...
            value: function() {
                ...
                jQuery('[data-toggle="theme"][data-theme="' + (e.length ? e.attr("href") : "default") + '"]').addClass("active"), this._lPage.off("click.pixelcave.themes"), this._lPage.on("click.pixelcave.themes", '[data-toggle="theme"]', function(t) {
                    ...
                    var l = jQuery(t.currentTarget),
                        n = l.data("theme");
                    jQuery('[data-toggle="theme"]').removeClass("active"), jQuery('[data-toggle="theme"][data-theme="' + n + '"]').addClass("active"), o.default.updateTheme(e, n), e = jQuery("#css-theme"), a && Cookies.set("dashmixThemeName", n, {
                        expires: 7
                    }), l.blur()
                })
            }
